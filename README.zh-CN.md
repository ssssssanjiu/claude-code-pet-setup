...
<p align="center">
  <img src="assets/pet-states.png" alt="桌宠的四种状态：待机、打扫、警觉、报错" width="620">
</p>
<p align="center">
  <sub>四个一眼可辨的状态。<code>sweeping</code> 是在压缩上下文，<code>attention</code> 是回合结束来叫你，
  <code>error</code> 会冒烟。<br>其余状态（<code>thinking</code>/<code>working</code>/<code>juggling</code>）
